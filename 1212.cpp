...
Cód Producto (3 díg) 
PU (precio unitario) 
y Stk (cantidad en stock)
Se pide Ingresar por consola pedidos hasta CodP=0 con Cód Producto y Cantidad Pedida,
informando por cada uno según haya stock suficiente o no: 
-el pedido solicitado tiene un importe de $9999,99 o 
-no puede entregarse el pedido por stock insuficiente o 
